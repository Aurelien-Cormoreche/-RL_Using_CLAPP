...
def parsing():
    ...
    parser.add_argument('--schedule_type_entropy', default='warmup_cosine_annealing', help='schedule type for the critic coefficient')
    parser.add_argument('--coeff_entropy_i', type=float, default=0, help='initial coefficient of the critic in the PPO loss')
    parser.add_argument('--coeff_entropy_e', type=float, default=0, help='end coefficient of the critic in the PPO loss')
    parser.add_argument('--coeff_entropy_m', type=float, default=0.01, help='max coefficient of the critic (for warmup schedule)')
