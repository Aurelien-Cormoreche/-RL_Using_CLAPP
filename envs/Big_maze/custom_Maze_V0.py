...
# - Creating simulation environments (gymnasium, MiniWorld)
# - Managing data types and structures (typing, numpy)
# - Handling images and textures (pyglet, OpenGL)
# - Managing entities and agents in the virtual world
...
# MAZE CLASS
# =============================================
# This class defines a maze environment where an agent must reach a red box.
# Several variants exist (MazeS2, MazeS3, MazeS3Fast) depending on the maze size and agent speed.
class Maze(MiniWorldEnv, utils.EzPickle):
    ...
    - MazeS2: 2x2 maze
    - MazeS3: 3x3 maze
    - MazeS3Fast: 3x3 maze with faster movement
    ...
    ## Observation Space
    A numpy array with shape (obs_height, obs_width, 3) representing an RGB image of what the agent sees.
    ...
    def __init__(
        ...
        **kwargs
        ...
        # --- Parameters ---
        # num_rows, num_cols: number of rows and columns in the maze grid
        # room_size: size of each room in the maze
        ...
        # intermediate_rewards: whether to give intermediate rewards
        ...
        # gap_size: space between rooms
        # isfirst: flag to check if it's the first reset
        ...
        utils.EzPickle.__init__(self, num_rows=num_rows, num_cols=num_cols, room_size=room_size, **kwargs)
    ...
    def _gen_world(self):
        """
        Generate the maze world: rooms, walls, and connections.
        Uses a recursive backtracking algorithm to create a maze.
        """
        rows = []
        # For each row
        ...
        def visit(i, j):
            ...
            See: https://stackoverflow.com/questions/38502
            """
            room = rows[j][i]
            visited.add(room)
            ...
            for dj, di in neighbors:
                ...
                # Connect rooms by removing walls
                if di == 0:
    ...
    def add_room(self, **kwargs):
        """
        Create a new room with custom parameters.
        """
    ...
    def turn_agent(self, turn_angle):
        """
        Override agent turning to make it faster.
        """
        turn_angle *= 3
...
# MAZE VARIANTS
# =============================================
# Smaller and faster variants of the Maze environment
...
# ROOMMAZE CLASS
# =============================================
# Custom room class for the maze, with custom textures and rendering
...
class RoomMaze(Room):
    ...
    def _gen_static_data(self, params, rng):
        ...
        """
        # Load textures and do texture randomization
        self.wall_tex = []
        for i in range(50):
        ...
        # Generate floor and ceiling vertices and texture coordinates
        ...
        def gen_seg_poly(edge_p0, side_vec, seg_start, seg_end, min_y, max_y, yes=False):
            """
            Generate a wall segment polygon.
            """
        ...
        # For each wall, generate polygons for rendering and collision
        for wall_idx in range(self.num_walls):
            ...
            for portal_idx, portal in enumerate(self.portals[wall_idx]):
                ...
                gen_seg_poly(edge_p0, side_vec, end_pos, next_portal_start, 0, self.wall_height, yes=True)
...
# =============================================
# Helper function to generate texture coordinates for walls
...
# MAIN BLOCK
# =============================================
# Register the environment and run manual control for testing
...
if __name__ == "__main__":
    ...
    # Create and run the environment with manual control
